...
export default function ListingDetails() {
  ...
  const listing: Listing =
    LISTINGS.find((l: Listing) => l.id === id) ?? LISTINGS[0];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-4 h-56 bg-slate-100 border border-slate-200 grid place-items-center text-slate-500">
              Map Placeholder
            </div>
          </div>
        </div>
        ...
        {/* Sticky Contact */}
        <div className="lg:sticky lg:top-28 border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-5 space-y-3">
            <button
              className="w-full px-4 py-3 text-sm font-semibold text-white shadow-sm hover:opacity-95 transition"
              style={{ backgroundColor: BRAND }}
            >
              Dërgo mesazh
            </button>

            <button className="w-full px-4 py-3 text-sm font-semibold border border-slate-200 hover:bg-slate-50 transition">
              Thirr
            </button>
