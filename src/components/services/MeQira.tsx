  ...
  return (
    <div className="space-y-8">
      <div className="flex items-end justify-between gap-4">
        <div>
          <h2 className="text-2xl font-light tracking-wide text-slate-900">For Rent</h2>
          <p className="mt-2 text-slate-500 font-light">
            Premium rentals with verified details and clean presentation.
          </p>
        </div>
            ...
            >
              ...
              <div className="p-5 space-y-2">
                <p className="text-sm font-extrabold text-slate-900">
                  €{money(l.price)} <span className="text-xs font-semibold text-slate-500">/muaj</span>
                </p>
